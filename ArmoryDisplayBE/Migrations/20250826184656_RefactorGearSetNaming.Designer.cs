...
namespace ArmoryDisplayBE.Migrations
{
    ...
    [Migration("20250826184656_RefactorGearSetNaming")]
    partial class RefactorGearSetNaming
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArmoryDisplayBE.Models.GearSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArmoryDisplayBE.Models.Stat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArmoryDisplayBE.Models.GearSet", b =>
                {
                    b.HasOne("ArmoryDisplayBE.Models.Stat", "BonusStats")
                        .WithMany()
            ...
            modelBuilder.Entity("ArmoryDisplayBE.Models.UserHeroGear", b =>
                {
                    b.HasOne("ArmoryDisplayBE.Models.GearSet", "GearSet")
                        .WithMany()
            ...
            modelBuilder.Entity("ArmoryDisplayBE.Models.UserHeroGearStats", b =>
                {
                    b.HasOne("ArmoryDisplayBE.Models.Stat", "GearStats")
                        .WithMany()
